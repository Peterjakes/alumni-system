...
<body class="bg-gray-100 font-sans leading-normal tracking-normal flex flex-col min-h-screen">
        ...
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="flex items-center">
                    <img src="https://www.isteducation.com/ist-content/uploads/2022/02/cropped-IST-logo-01-2048x2048-1-2.png" alt="IST College Logo" class="h-32 mr-3">
    ...
    @endauth
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white py-2 shadow-lg">
            ...
            <a href="{{ route('events.index') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Events</a>
            @auth
        ...
        <div class="container mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('donations.create') }}" class="hover:text-white">Payments</a></li>
